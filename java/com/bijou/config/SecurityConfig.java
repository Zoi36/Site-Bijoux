...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHERS = { "/css/**", "/js/**", "/image/**", "/", "/newUser",
			"/forgetPassword", "/login", "/fonts/**", "/creations", "/ringPersonnalise", "/alliancePersonnalise",
			"/earringsPersonnalise", "/necklacePersonnalise", "/productPresentation", "/productSelect",
			"/ringSimpleReadyPresentation", "/allianceReadyPresentation", "/earringsReadyPresentation",
			"/necklaceReadyPresentation",
